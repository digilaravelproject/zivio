...
export function ApplicationAccordion({
    ...
    return (
        <motion.figure
            ...
            className="relative"
        >
            <div className="cinematic-image-frame relative h-[300px] sm:h-[430px] md:h-[500px] lg:h-[560px] xl:h-[620px]">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A]/78 via-[#0A0A0A]/14 to-transparent" />
                <div className="absolute inset-0 shadow-[inset_0_0_120px_rgba(184,148,95,0.1)]" />
                ...
                <figcaption className="absolute inset-x-4 bottom-4 sm:inset-x-7 sm:bottom-7">
                    <span className="mb-3 block h-px w-10 bg-[#BDA18A]/80 sm:mb-4 sm:w-12" />
