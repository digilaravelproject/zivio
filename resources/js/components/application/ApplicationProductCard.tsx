...
export function ApplicationProductCard({ product }: ApplicationProductCardProps) {
    return (
        <Link
            href={product.href}
            className="group block w-[10.5rem] overflow-hidden border border-white/[0.1] bg-[#080808]/78 p-2.5 shadow-[0_28px_78px_rgba(0,0,0,0.42),0_0_42px_rgba(184,148,95,0.1)] backdrop-blur-xl transition duration-500 hover:-translate-y-1 hover:border-[#BDA18A]/50 sm:w-[12.75rem] sm:p-3 lg:w-[14rem]"
        >
            ...
            <div className="pt-3 sm:pt-4">
                <p className="mb-2 font-sans text-[0.56rem] font-medium tracking-[0.18em] text-[#BDA18A] uppercase">
                    {product.category}
                </p>
