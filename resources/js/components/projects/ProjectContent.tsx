    ...
    return (
        <div className="relative z-10">
            <div className="mb-5 flex items-center gap-4">
                ...
                <p className="font-sans text-[0.64rem] font-semibold tracking-[0.34em] text-[#BDA18A] uppercase">
                    Our Projects
                </p>
            </div>
            ...
            <motion.div
                ...
                className="mt-8 border-l border-[#BDA18A]/28 pl-5"
            >
                <p className="mb-3 inline-flex border border-[#BDA18A]/22 bg-[#BDA18A]/7 px-3 py-1.5 font-sans text-[0.62rem] font-semibold tracking-[0.22em] text-[#BDA18A] uppercase">
                    {project.category}
                </p>
                ...
                <p className="mt-2 font-sans text-sm tracking-[0.16em] text-[#BDA18A] uppercase">
                    {project.location}
                </p>
                ...
                <Link
                    href={project.href}
                    className="mt-7 inline-flex w-full items-center justify-center gap-2 border border-[#BDA18A]/55 px-5 py-3 font-sans text-[0.66rem] font-semibold tracking-[0.2em] text-[#F5F5F2] uppercase transition duration-500 hover:border-[#F5F5F2] hover:bg-[#F5F5F2] hover:text-[#0A0A0A] sm:w-auto"
                >
                    Read More
