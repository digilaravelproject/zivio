...
export function BrandStorySection() {
    return (
        <section className="relative overflow-hidden bg-[#0A0A0A] px-4 py-16 text-[#F5F5F2] sm:px-6 sm:py-20 lg:px-10 lg:py-28">
            ...
            <div className="pointer-events-none absolute top-1/2 right-[-8rem] h-96 w-96 -translate-y-1/2 rounded-full bg-[#B89B72]/12 blur-3xl" />
            <div className="pointer-events-none absolute bottom-0 left-0 h-px w-full bg-gradient-to-r from-transparent via-[#B89B72]/30 to-transparent" />
            ...
            >
                <div className="max-w-[640px]">
                    <div className="mb-7 flex items-center gap-5">
                        <span className="h-px w-12 bg-[#B89B72]" />
                    ...
                    <div className="mt-10 grid max-w-sm grid-cols-[auto_1fr] items-center gap-4 text-[#B89B72]">
                        <span className="grid size-14 place-items-center border border-[#B89B72]/35 text-xs font-semibold tracking-[0.22em] uppercase">
                            01
                        </span>
                ...
                >
                    <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#B89B72]/65 to-transparent" />
                    <div className="pointer-events-none absolute -right-20 -bottom-20 h-56 w-56 rounded-full bg-[#B89B72]/10 blur-3xl" />
