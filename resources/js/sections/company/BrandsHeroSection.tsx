    ...
    return (
        <section className="relative min-h-[60vh] sm:min-h-[75vh] flex items-center justify-center overflow-hidden px-4 pt-24 pb-12 sm:px-6 lg:px-10">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src={brandsPageData.hero.backgroundImage}
                    alt="ZIVIO modern architectural lighting brands"
            ...
            <div className="relative z-10 w-full max-w-7xl">
                {/* Breadcrumbs */}
                <div
                    className="mb-8 flex items-center gap-2.5 font-sans text-[0.66rem] font-medium tracking-[0.25em] text-[#CFCFCB] uppercase transition-all duration-[800ms] ease-out"
                    style={{
                ...
                >
                    ...
                    <span className="text-[#BDA18A]">Our Brands</span>
                </div>
