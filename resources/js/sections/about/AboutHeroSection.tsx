...
import { heroData } from '@/data/aboutPageData';
        ...
        <section className="relative min-h-[60vh] sm:min-h-[75vh] flex items-center justify-center overflow-hidden px-4 pt-24 pb-12 sm:px-6 lg:px-10">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    alt="Luxury architectural lighting showcase"
                    className="h-full w-full object-cover object-center brightness-[0.38] scale-105"
                    loading="eager"
                />
